...
import nav from '../.vuepress/nav'

const DOMAIN_NAME = 'kevin.icu' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'https://github.com/kevin020121', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'kevin', // 必需
      link: 'https://github.com/kevin020121', // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'kevin | <a href="https://github.com/kevin020121" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
